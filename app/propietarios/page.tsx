...
export default function PropietariosPage() {
  ...
  const propertyTypes = [
    'Casa', 'Casa en condominio', 'Residencia', 'Departamento', 'Penthouse', 'Loft', 'Dúplex', 'Villa',
    'Quinta', 'Cabaña', 'Rancho', 'Hacienda', 'Finca', 'Condominio', 'Terreno campestre', 'Históricos',
    'Terreno habitacional', 'Terreno comercial', 'Terreno industrial', 'Terreno agrícola', 'Terreno mixto',
    'Local comercial', 'Plaza comercial', 'Oficina', 'Consultorio', 'Edificio comercial', 'Edificio mixto',
    'Hotel', 'Hospital', 'Clínica', 'Centro médico', 'Restaurante', 'Salón de eventos', 'Nave industrial',
    'Bodega industrial', 'Bodega comercial', 'Parque industrial', 'Patio de maniobras', 'Complejo habitacional',
    'Centro de negocios', 'Granja', 'Motel'
  ]
  ...
  const handleSubmit = async () => {
    ...
    if (!formData.categoria) {
      toast.error(l('Selecciona una categoría para tu propiedad', 'Select a category for your property'))
      return
    }
              ...
              <div className="flex items-center mb-6">
                ...
                <div>
                  <h2 className="font-serif text-2xl font-semibold text-[#17313A] dark:text-white">
                    {l('Información de la propiedad', 'Property information')}
                  </h2>
                  <p className="text-[#4A4F57] dark:text-[#4A4F57] dark:text-[#B0ACA6]">{l('Cuéntanos sobre tu propiedad exclusiva', 'Tell us about your exceptional property')}</p>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="md:col-span-2 space-y-2">
                  <Label htmlFor="titulo" className="text-sm font-medium text-[#17313A] dark:text-[#EAE4DD]">
                    {l('Título de la propiedad *', 'Property title *')}
                  </Label>
                  <Input
                    id="titulo"
                    placeholder={l('Ej: Casa en coto Lomas del Moral', 'e.g. Home in Lomas del Moral')}
                ...
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger className="bg-[#17313A]/5 dark:bg-white/5 border-[#17313A]/20 dark:border-white/20 text-[#17313A] dark:text-[#17313A] dark:text-white placeholder:text-[#4A4F57] focus:border-[var(--conectia-arcilla)] focus:ring-[var(--conectia-arcilla)]/20">
                      <SelectValue placeholder={l('Selecciona el tipo', 'Select a property type')} />
                    </SelectTrigger>
                    <SelectContent>
                      {propertyTypes.map(type => <SelectItem key={type} value={type}>{translatePropertyValue(type, language)}</SelectItem>)}
                    </SelectContent>
                  </Select>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger className="bg-[#17313A]/5 dark:bg-white/5 border-[#17313A]/20 dark:border-white/20 text-[#17313A] dark:text-[#17313A] dark:text-white placeholder:text-[#4A4F57] focus:border-[var(--conectia-arcilla)] focus:ring-[var(--conectia-arcilla)]/20">
                      <SelectValue placeholder={l('Selecciona la categoría', 'Select a category')} />
                    </SelectTrigger>
                    <SelectContent>
                      {PUBLIC_PROPERTY_CATEGORIES.map((category) => (
                        <SelectItem key={category.value} value={category.value}>{translatePropertyValue(category.label, language)}</SelectItem>
                      ))}
                    </SelectContent>
                  </Select>
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="area" className="text-sm font-medium text-[#17313A] dark:text-[#17313A] dark:text-[#EAE4DD]">
                    {l('Área total (m²) *', 'Total area (m²) *')}
                  </Label>
                  <Input
                    id="area"
                    placeholder={l('Ej: 450', 'e.g. 450')}
                    value={formData.area}
                ...
                <div className="space-y-2">
                  <Label htmlFor="area-construccion" className="text-sm font-medium text-[#17313A] dark:text-[#17313A] dark:text-[#EAE4DD]">
                    {l('Área de construcción (m²)', 'Built area (m²)')}
                  </Label>
                  <Input
                    ...
                    step="0.01"
                    min="0"
                    placeholder={l('Ej: 350 (opcional)', 'e.g. 350 (optional)')}
                ...
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger className="bg-[#17313A]/5 dark:bg-white/5 border-[#17313A]/20 dark:border-white/20 text-[#17313A] dark:text-[#17313A] dark:text-white placeholder:text-[#4A4F57] focus:border-[var(--conectia-arcilla)] focus:ring-[var(--conectia-arcilla)]/20">
                      <SelectValue placeholder={l('Número de habitaciones', 'Number of bedrooms')} />
                    </SelectTrigger>
                    <SelectContent>
                      {[0,1,2,3,4,5,6].map(number => <SelectItem key={number} value={String(number)}>{number === 6 ? '6+' : number} {language === 'en' ? (number === 1 ? 'bedroom' : 'bedrooms') : (number === 1 ? 'habitación' : 'habitaciones')}</SelectItem>)}
                    </SelectContent>
                  </Select>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger className="bg-[#17313A]/5 dark:bg-white/5 border-[#17313A]/20 dark:border-white/20 text-[#17313A] dark:text-[#17313A] dark:text-white placeholder:text-[#4A4F57] focus:border-[var(--conectia-arcilla)] focus:ring-[var(--conectia-arcilla)]/20">
                      <SelectValue placeholder={l('Número de baños', 'Number of bathrooms')} />
                    </SelectTrigger>
                    <SelectContent>
                      {[0,1,2,3,4,5,6].map(number => <SelectItem key={number} value={String(number)}>{number === 6 ? '6+' : number} {language === 'en' ? (number === 1 ? 'bathroom' : 'bathrooms') : (number === 1 ? 'baño' : 'baños')}</SelectItem>)}
                    </SelectContent>
                  </Select>
                </div>
              </div>
              ...
              {priceEstimate && (
                <div className="mt-6 p-4 bg-conectia-gold/10 rounded-lg border border-conectia-gold/20">
                  <div className="flex items-center mb-2">
                    ...
                    <h3 className="font-semibold text-conectia-gold">{l('Valoración estimada por IA', 'AI-powered estimated value')}</h3>
                  </div>
                  ...
                  <p className="text-sm text-[#4A4F57] dark:text-[#B0ACA6] mt-1">
                    {l('Estimación basada en ubicación y características similares', 'Estimate based on location and comparable property features')}
                  </p>
                </div>
              )}
            </div>
          ...
          {currentStep === 2 && (
            <div className="p-8">
              <div className="flex items-center mb-6">
                ...
                <div>
                  <h2 className="font-serif text-2xl font-semibold text-[#17313A] dark:text-white">
                    {l('Ubicación privilegiada', 'Prime location')}
                  </h2>
                  <p className="text-[#4A4F57] dark:text-[#B0ACA6]">{l('La ubicación es clave para maximizar el valor', 'Location is key to maximizing your property’s value')}</p>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="md:col-span-2 space-y-2">
                  <Label htmlFor="address" className="text-sm font-medium text-[#17313A] dark:text-[#EAE4DD]">
                    {l('Dirección completa *', 'Full address *')}
                  </Label>
                  <Input
                    id="address"
                    placeholder={l('Calle, número, colonia', 'Street, number, and neighborhood')}
                ...
                <div className="space-y-2">
                  <Label htmlFor="neighborhood" className="text-sm font-medium text-[#17313A] dark:text-[#EAE4DD]">
                    {l('Colonia/Zona *', 'Neighborhood/Area *')}
                  </Label>
                  <Popover open={neighborhoodOpen} onOpenChange={(open) => {
                    ...
                    >
                      <Command>
                        <CommandInput
                          placeholder={l('Buscar zona...', 'Search for an area...')}
                          value={neighborhoodQuery}
                          onValueChange={setNeighborhoodQuery}
                        />
                        <CommandList>
                          <CommandEmpty>{l('No se encontró la zona.', 'No area found.')}</CommandEmpty>
                          <CommandGroup>
                ...
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger className="bg-[#17313A]/5 dark:bg-white/5 border-[#17313A]/20 dark:border-white/20 text-[#17313A] dark:text-[#17313A] dark:text-white placeholder:text-[#4A4F57] focus:border-[var(--conectia-arcilla)] focus:ring-[var(--conectia-arcilla)]/20">
                      <SelectValue placeholder={l('Selecciona la ciudad', 'Select a city')} />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="Ciudad de México">{l('Ciudad de México', 'Mexico City')}</SelectItem>
                ...
                <div className="space-y-2">
                  <Label htmlFor="postal-code" className="text-sm font-medium text-[#17313A] dark:text-[#EAE4DD]">
                    {l('Código postal', 'Postal code')}
                  </Label>
                  <Input
                    id="postal-code"
                    placeholder={l('Ej: 11560', 'e.g. 11560')}
          ...
          {currentStep === 3 && (
            <div className="p-8">
              <div className="flex items-center mb-6">
                ...
                <div>
                  <h2 className="font-serif text-2xl font-semibold text-[#17313A] dark:text-white">
                    {l('Detalles y precio', 'Details and pricing')}
                  </h2>
                  <p className="text-[#4A4F57] dark:text-[#B0ACA6]">{l('Características que hacen única tu propiedad', 'The features that make your property stand out')}</p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <Label htmlFor="asking-price" className="text-sm font-medium text-[#17313A] dark:text-[#EAE4DD]">
                      {formData.tipoConsulta === 'rentar' ? l('Renta mensual (MXN) *', 'Monthly rent (MXN) *') : l('Precio solicitado (MXN) *', 'Asking price (MXN) *')}
                    </Label>
                    <Input
                      id="asking-price"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="urgency" className="text-sm font-medium text-[#17313A] dark:text-[#EAE4DD]">
                      {l('Tiempo ideal de venta', 'Ideal selling timeframe')}
                    </Label>
                    <Select
                    ...
                    >
                      <SelectTrigger className="bg-[#17313A]/5 dark:bg-white/5 border-[#17313A]/20 dark:border-white/20 text-[#17313A] dark:text-[#17313A] dark:text-white placeholder:text-[#4A4F57] focus:border-[var(--conectia-arcilla)] focus:ring-[var(--conectia-arcilla)]/20">
                        <SelectValue placeholder={l('Selecciona tiempo ideal', 'Select a timeframe')} />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="urgent">{l('Menos de 3 meses', 'Under 3 months')}</SelectItem>
                        <SelectItem value="medium">{l('3-6 meses', '3–6 months')}</SelectItem>
                        <SelectItem value="flexible">{l('6-12 meses', '6–12 months')}</SelectItem>
                        <SelectItem value="patient">{l('Sin prisa, busco el mejor precio', 'No rush—I want the best price')}</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="tipo-consulta" className="text-sm font-medium text-[#17313A] dark:text-[#EAE4DD]">
                      {l('Tipo de consulta', 'How can we help?')}
                    </Label>
                    <Select
                    ...
                    >
                      <SelectTrigger className="bg-[#17313A]/5 dark:bg-white/5 border-[#17313A]/20 dark:border-white/20 text-[#17313A] dark:text-[#17313A] dark:text-white placeholder:text-[#4A4F57] focus:border-[var(--conectia-arcilla)] focus:ring-[var(--conectia-arcilla)]/20">
                        <SelectValue placeholder={l('Selecciona una opción', 'Select an option')} />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="vender">{l('Vender mi propiedad', 'Sell my property')}</SelectItem>
                        <SelectItem value="rentar">{l('Rentar mi propiedad', 'Rent out my property')}</SelectItem>
                        <SelectItem value="comprar">{l('Comprar propiedad', 'Buy a property')}</SelectItem>
                        <SelectItem value="general">{l('Consulta general', 'General inquiry')}</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="no">{l('Sin gravamen', 'No lien')}</SelectItem>
                        <SelectItem value="si">{l('Con gravamen', 'Subject to a lien')}</SelectItem>
                        <SelectItem value="en_proceso">{l('En proceso de liberación', 'Lien release in progress')}</SelectItem>
                        <SelectItem value="desconocido">{l('Desconocido', 'Unknown')}</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  <div className="space-y-2">
                    <Label htmlFor="description" className="text-sm font-medium text-[#17313A] dark:text-[#EAE4DD]">
                      {l('Descripción de la propiedad *', 'Property description *')}
                    </Label>
                    <Textarea
                      id="description"
                      placeholder={l('Describe las características especiales, acabados de lujo, vistas, etc.', 'Describe standout features, luxury finishes, views, and other details.')}
                      rows={4}
                  ...
                  <div className="space-y-2">
                    <Label className="text-sm font-medium text-[#17313A] dark:text-[#EAE4DD]">
                      {l('Características especiales', 'Special features')}
                    </Label>
                    <p className="text-xs text-[#4A4F57] mb-2">{l('Selecciona las características especiales de tu propiedad', 'Select your property’s special features')}</p>
                  ...
                  <div className="space-y-2">
                    <Label className="text-sm font-medium text-[#17313A] dark:text-[#EAE4DD]">
                      {l('Actividades recreativas (opcional)', 'Recreational activities (optional)')}
                    </Label>
                    <p className="text-xs text-[#4A4F57] mb-2">{l('Selecciona las actividades que ofrece el desarrollo', 'Select the activities available in the development')}</p>
                    <div className="grid grid-cols-2 gap-2">
                ...
                <div className="space-y-3">
                  <Label className="text-sm font-semibold text-[#17313A] dark:text-[#EAE4DD]">{l('Amenidades del desarrollo', 'Development amenities')}</Label>
                  <p className="text-xs text-[#4A4F57] dark:text-[#B0ACA6]">{l('Selecciona las amenidades disponibles en el desarrollo o condominio', 'Select the amenities available in the development or condominium')}</p>
                  <div className="grid grid-cols-2 gap-2">
                ...
                <div className="mt-8 p-6 bg-[#EAE4DD]/50 dark:bg-[#17313A]/50 rounded-xl border border-[var(--conectia-arcilla)]/30">
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      <h3 className="font-serif text-lg font-semibold text-[#17313A] dark:text-white">
                        {l('Promoción o bono especial', 'Special offer or incentive')}
                      </h3>
                      <p className="text-xs text-[#4A4F57]">{l('Agrega un incentivo para atraer más compradores', 'Add an incentive to attract more buyers')}</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <Label className="text-sm font-medium text-[#17313A] dark:text-[#EAE4DD]">
                        {l('Selecciona una promoción (opcional)', 'Select an offer (optional)')}
                      </Label>
                      <Select
                      ...
                      >
                        <SelectTrigger className="bg-[#17313A]/5 dark:bg-white/5 border-[#17313A]/20 dark:border-white/20 text-[#17313A] dark:text-[#17313A] dark:text-white placeholder:text-[#4A4F57] focus:border-[var(--conectia-arcilla)] focus:ring-[var(--conectia-arcilla)]/20">
                          <SelectValue placeholder={l('Sin promoción', 'No offer')} />
                        </SelectTrigger>
                        <SelectContent>
                          <SelectItem value="ninguna">{l('Sin promoción', 'No offer')}</SelectItem>
                          <SelectItem value="escrituras_gratis">{l('Escrituras gratis', 'Closing costs included')}</SelectItem>
                          <SelectItem value="meses_mantenimiento">{l('3 meses de mantenimiento gratis', '3 months of HOA fees included')}</SelectItem>
                          <SelectItem value="mudanza_gratis">{l('Mudanza incluida', 'Moving service included')}</SelectItem>
                          <SelectItem value="descuento_5">{l('5% de descuento por cierre rápido', '5% quick-close discount')}</SelectItem>
                          <SelectItem value="descuento_10">{l('10% de descuento por pago de contado', '10% cash-purchase discount')}</SelectItem>
                          <SelectItem value="amueblado">{l('Incluye mobiliario / amueblado', 'Furniture included')}</SelectItem>
                          <SelectItem value="remodelacion">{l('Remodelación incluida', 'Renovation included')}</SelectItem>
                          <SelectItem value="electrodomesticos">{l('Electrodomésticos incluidos', 'Appliances included')}</SelectItem>
                          <SelectItem value="estacionamiento_extra">{l('Estacionamiento extra sin costo', 'Complimentary extra parking space')}</SelectItem>
                          <SelectItem value="bodega_extra">{l('Bodega adicional incluida', 'Additional storage included')}</SelectItem>
                          <SelectItem value="comision_reducida">{l('Comisión reducida al comprador', 'Reduced buyer commission')}</SelectItem>
                          <SelectItem value="personalizada">{l('Otra promoción (personalizada)', 'Other offer (custom)')}</SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
                    ...
                    {formData.promocion === 'personalizada' && (
                      <div className="space-y-2">
                        <Label className="text-sm font-medium text-[#17313A] dark:text-[#EAE4DD]">
                          {l('Describe tu promoción personalizada', 'Describe your custom offer')}
                        </Label>
                        <Input
                          placeholder={l("Ej: Regalo de pantalla 65'' al cerrar trato", "e.g. 65-inch TV included at closing")}
                    ...
                    {formData.promocion && formData.promocion !== 'ninguna' && (
                      <div className="p-3 bg-conectia-gold/20 rounded-lg border border-conectia-gold/40">
                        <p className="text-xs text-[#4A4F57] dark:text-[#B0ACA6] mb-1">{l('Vista previa del bono en la publicación:', 'Listing incentive preview:')}</p>
          ...
          {currentStep === 4 && (
            <div className="p-8">
              <div className="flex items-center mb-6">
                ...
                <div>
                  <h2 className="font-serif text-2xl font-semibold text-[#17313A] dark:text-white">
                    {l('Fotografías profesionales', 'Professional photography')}
                  </h2>
                  <p className="text-[#4A4F57] dark:text-[#B0ACA6]">{l('Las imágenes son clave para atraer compradores', 'Strong imagery is essential for attracting buyers')}</p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="border-2 border-dashed border-[var(--conectia-arcilla)]/30 rounded-xl p-8 text-center bg-[var(--conectia-arcilla)]/5">
                  ...
                  <h3 className="text-lg font-semibold text-[#17313A] dark:text-[#17313A] dark:text-white mb-2">
                    {l('Sube las fotos de tu propiedad', 'Upload your property photos')}
                  </h3>
                  <p className="text-[#4A4F57] dark:text-[#B0ACA6] mb-4">
                    {l('Arrastra y suelta las imágenes o haz clic para seleccionar', 'Drag and drop images here, or click to select files')}
                  </p>
                  <input
                    type="file"
                    multiple
                  ...
                  <label htmlFor="photo-upload">
                    ...
                    >
                      <span>
                        ...
                        {l('Seleccionar fotos', 'Select photos')}
                      </span>
                    </Button>
                  </label>
                  <p className="text-xs text-[#4A4F57] mt-2">
                    {l('Máximo 30 fotos • JPG, PNG • Máximo 10MB por foto', 'Up to 30 photos • JPG or PNG • 10MB maximum per photo')}
                  </p>
                </div>
                ...
                {uploadedPhotos.length > 0 && (
                  <div>
                    <h4 className="font-semibold text-[#17313A] dark:text-[#17313A] dark:text-white mb-4">
                      {l('Fotos subidas', 'Uploaded photos')} ({uploadedPhotos.length})
                    </h4>
                ...
                <div className="bg-[#17313A]/50 border border-[var(--conectia-arcilla)]/20 rounded-xl p-4">
                  <h4 className="font-semibold text-[var(--conectia-arcilla)] mb-2">
                    💡 {l('Tips para mejores fotos', 'Tips for better photos')}
                  </h4>
                  <ul className="text-sm text-[#4A4F57] dark:text-[#B0ACA6] space-y-1">
                    <li>• {l('Toma fotos con buena iluminación natural', 'Use plenty of natural light')}</li>
                    <li>• {l('Incluye todas las habitaciones principales', 'Include every main room')}</li>
                    <li>• {l('Muestra las amenidades especiales', 'Showcase standout amenities')}</li>
                    <li>• {l('Captura las vistas panorámicas', 'Capture panoramic views')}</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          {currentStep === 5 && (
            <div className="p-8">
              <div className="flex items-center mb-6">
                ...
                <div>
                  <h2 className="font-serif text-2xl font-semibold text-[#17313A] dark:text-white">
                    {l('Información de contacto', 'Contact information')}
                  </h2>
                  <p className="text-[#4A4F57] dark:text-[#B0ACA6]">{l('Finaliza tu registro exclusivo', 'Complete your property submission')}</p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input
                      id="owner-name"
                      placeholder={l('Tu nombre completo', 'Your full name')}
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="email" className="text-sm font-medium text-[#17313A] dark:text-[#EAE4DD]">
                      {l('Correo electrónico *', 'Email address *')}
                    </Label>
                    <Input
                      id="email"
                      type="email"
                      placeholder={l('tu@email.com', 'you@example.com')}
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="preferred-contact" className="text-sm font-medium text-[#17313A] dark:text-[#EAE4DD]">
                      {l('Horario preferido', 'Preferred contact time')}
                    </Label>
                    <Select
                    ...
                    >
                      <SelectTrigger className="bg-[#17313A]/5 dark:bg-white/5 border-[#17313A]/20 dark:border-white/20 text-[#17313A] dark:text-[#17313A] dark:text-white placeholder:text-[#4A4F57] focus:border-[var(--conectia-arcilla)] focus:ring-[var(--conectia-arcilla)]/20">
                        <SelectValue placeholder={l('Selecciona horario', 'Select a time')} />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="morning">{l('Mañana (9:00 - 12:00)', 'Morning (9:00 a.m.–12:00 p.m.)')}</SelectItem>
                        <SelectItem value="afternoon">{l('Tarde (12:00 - 18:00)', 'Afternoon (12:00–6:00 p.m.)')}</SelectItem>
                        <SelectItem value="evening">{l('Noche (18:00 - 21:00)', 'Evening (6:00–9:00 p.m.)')}</SelectItem>
                        <SelectItem value="anytime">{l('Cualquier horario', 'Any time')}</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-br from-conectia-gold/5 to-transparent p-6 rounded-xl border border-conectia-gold/20">
                  <h3 className="font-serif text-xl font-semibold text-[#17313A] dark:text-[#17313A] dark:text-white mb-4">
                    {l('Tipo de acuerdo', 'Representation agreement')}
                  </h3>
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      <Checkbox
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <Label htmlFor="terms" className="text-sm leading-relaxed">
                        ...
                        <Link href="/legal/terminos-condiciones" target="_blank" className="font-bold text-[var(--conectia-arcilla)] hover:underline">{l('términos y condiciones', 'terms and conditions')}</Link>{' '}
                        {l('del servicio de CONECTIA, incluyendo la comisión competitiva del 4% sobre el precio final de venta.', 'of CONECTIA’s service, including the competitive 4% commission on the final sale price.')}
                      </Label>
                    </div>
                    <div className="flex items-start space-x-3">
                      <Checkbox
                      ...
                      <Label htmlFor="privacy" className="text-sm leading-relaxed">
                        ...
                        {l('de CONECTIA para fines de comercialización de mi propiedad.', 'for the purpose of marketing my property.')}
                      </Label>
                    </div>
                  </div>
                </div>
          ...
          <div className="px-8 py-6 bg-[#EAE4DD]/80 dark:bg-[#0F2027]/80 border-t border-[#17313A]/5 dark:border-white/5">
                  ...
                  >
                    {isSubmitting ? (
                      ...
                      <>
                        ...
                        {l('Registrar propiedad exclusiva', 'Submit property')}
                      </>
                    )}
                  </Button>
                )}
            ...
            {currentStep === totalSteps && (
              <p className="text-sm text-[#4A4F57] mt-4 text-center">
                🚀 {l('Un especialista de CONECTIA se pondrá en contacto contigo en las próximas 2 horas', 'A CONECTIA specialist will contact you within the next two hours')}
              </p>
            )}
          </div>
        </Card>
