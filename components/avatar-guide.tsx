...
const GUIDE_SPEECHES: GuideSpeech[] = [
  {
    ...
    title: "¡Bienvenido!",
    icon: Sparkles,
    speech: "¡Hola! Soy tu guía virtual de CONECTIA SELECT. Te voy a mostrar cómo navegar por nuestra plataforma inmobiliaria de manera rápida y sencilla. Somos tu inmobiliaria de confianza en León, Guanajuato. ¡Empecemos!",
    shortSpeech: "Bienvenido a CONECTIA SELECT, tu inmobiliaria de confianza.",
    route: "/",
    scrollToTop: true,
  },
  {
  ...
  },
  {
    ...
    title: "¡Listo!",
    icon: Sparkles,
    speech: "¡Eso es todo! Ya conoces lo básico de CONECTIA SELECT. Recuerda: proceso transparente, sin complicaciones y conexión directa entre compradores y vendedores. ¡Explora y encuentra tu próximo hogar!",
