            ...
            <div className="relative bg-white/[0.03] backdrop-blur-md border border-white/10 rounded-[28px] p-6 sm:p-8 shadow-2xl overflow-hidden">
              ...
              <div className="relative">
                ...
                <Tabs defaultValue="descripcion" className="w-full">
                  <TabsList className="grid w-full grid-cols-4 gap-1 bg-white/5 p-1 rounded-xl">
                    <TabsTrigger value="descripcion" className="flex flex-col items-center gap-1 py-2.5 px-1 rounded-lg text-[10px] sm:text-xs font-medium text-[#4A4F57] data-[state=active]:bg-[#C78F7B]/20 data-[state=active]:text-[#C78F7B] data-[state=active]:border data-[state=active]:border-[#C78F7B]/30 transition-all">
                      <FileText className="h-4 w-4" />
                      <span className="hidden sm:inline">Descripción</span>
                    </TabsTrigger>
                    <TabsTrigger value="caracteristicas" className="flex flex-col items-center gap-1 py-2.5 px-1 rounded-lg text-[10px] sm:text-xs font-medium text-[#4A4F57] data-[state=active]:bg-[#C78F7B]/20 data-[state=active]:text-[#C78F7B] data-[state=active]:border data-[state=active]:border-[#C78F7B]/30 transition-all">
                      <Sparkles className="h-4 w-4" />
                      <span className="hidden sm:inline">Amenidades</span>
                    </TabsTrigger>
                    <TabsTrigger value="detalles" className="flex flex-col items-center gap-1 py-2.5 px-1 rounded-lg text-[10px] sm:text-xs font-medium text-[#4A4F57] data-[state=active]:bg-[#C78F7B]/20 data-[state=active]:text-[#C78F7B] data-[state=active]:border data-[state=active]:border-[#C78F7B]/30 transition-all">
                      <Info className="h-4 w-4" />
                      <span className="hidden sm:inline">Detalles</span>
                    </TabsTrigger>
                    <TabsTrigger value="ubicacion" className="flex flex-col items-center gap-1 py-2.5 px-1 rounded-lg text-[10px] sm:text-xs font-medium text-[#4A4F57] data-[state=active]:bg-[#C78F7B]/20 data-[state=active]:text-[#C78F7B] data-[state=active]:border data-[state=active]:border-[#C78F7B]/30 transition-all">
