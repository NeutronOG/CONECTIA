  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30">
      ...
      <div className="pt-24 pb-16 text-center">
        <h1 className="font-serif text-5xl md:text-6xl font-light text-conectia-graphite mb-6">Información Legal</h1>
      ...
      <div className="max-w-4xl mx-auto px-6 pb-24 space-y-8">
        {/* Privacy Policy */}
        <Card className="p-8 rounded-3xl border-0 bg-conectia-secondary/50 shadow-xl">
          <h2 className="font-serif text-3xl font-semibold text-conectia-graphite mb-6">Política de Privacidad</h2>
          <div className="prose prose-gray max-w-none">
            <p className="mb-4">
              En CONECTIA, protegemos tu privacidad y datos personales conforme al Reglamento General de Protección de
              Datos (RGPD).
            </p>
            <h3 className="text-xl font-semibold text-conectia-graphite mt-6 mb-3">Datos que recopilamos</h3>
            ...
            <h3 className="text-xl font-semibold text-conectia-graphite mt-6 mb-3">Uso de los datos</h3>
            <ul className="list-disc pl-6 mb-4">
        ...
        {/* Terms of Use */}
        <Card className="p-8 rounded-3xl border-0 bg-conectia-secondary/50 shadow-xl">
          <h2 className="font-serif text-3xl font-semibold text-conectia-graphite mb-6">Términos de Uso</h2>
          <div className="prose prose-gray max-w-none">
            <h3 className="text-xl font-semibold text-conectia-graphite mt-6 mb-3">Servicios</h3>
            <p className="mb-4">
              CONECTIA proporciona servicios de intermediación inmobiliaria exclusiva para propiedades de lujo.
            </p>
            <h3 className="text-xl font-semibold text-conectia-graphite mt-6 mb-3">Responsabilidades del cliente</h3>
            <ul className="list-disc pl-6 mb-4">
            ...
            <h3 className="text-xl font-semibold text-conectia-graphite mt-6 mb-3">Limitación de responsabilidad</h3>
            <p className="mb-4">
        ...
        {/* Cookies Policy */}
        <Card className="p-8 rounded-3xl border-0 bg-conectia-secondary/50 shadow-xl">
          <h2 className="font-serif text-3xl font-semibold text-conectia-graphite mb-6">Política de Cookies</h2>
          <div className="prose prose-gray max-w-none">
            <p className="mb-4">
              Utilizamos cookies para mejorar tu experiencia en nuestro sitio web y proporcionar servicios
              personalizados.
            </p>
            <h3 className="text-xl font-semibold text-conectia-graphite mt-6 mb-3">Tipos de cookies</h3>
            <ul className="list-disc pl-6 mb-4">
              <li>
            ...
            <h3 className="text-xl font-semibold text-conectia-graphite mt-6 mb-3">Control de cookies</h3>
            <p className="mb-4">
