...
export function Footer() {
  ...
  return (
    <footer className="bg-[#F6F2EE] dark:bg-[#0F2027] text-[#17313A] dark:text-white relative overflow-hidden transition-colors duration-300">
      {/* Glow orbs */}
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-[#17313A]/8 dark:bg-[var(--conectia-arcilla)]/8 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-0 right-1/4 w-64 h-64 bg-[#17313A]/10 dark:bg-[var(--conectia-arcilla)]/10 rounded-full blur-[100px] pointer-events-none" />

      {/* Top gradient line */}
      <div className="h-[1px] bg-gradient-to-r from-transparent via-[#17313A]/30 dark:via-[var(--conectia-arcilla)]/30 to-transparent" />
      ...
      <div className="max-w-7xl mx-auto relative z-10 px-4 sm:px-8 lg:px-16 py-16 sm:py-20">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 mb-16 pb-16 border-b border-[#17313A]/10 dark:border-white/10">
          <div className="max-w-lg">
            <h3 className="font-serif text-3xl sm:text-4xl font-black text-[#17313A] dark:text-[var(--conectia-arcilla)] mb-3">
              {t('home.cta.title')}
            </h3>
          ...
          <div className="flex flex-col sm:flex-row gap-3 flex-shrink-0">
            <Link href="/contacto">
              <button className="flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-[#17313A] hover:bg-[var(--conectia-arcilla-hover)] dark:bg-[var(--conectia-arcilla)] dark:hover:bg-[var(--conectia-arcilla-hover)] text-[#EAE4DD] dark:text-[#0F2027] font-bold transition-all duration-300 hover:scale-[1.02] shadow-lg shadow-[#17313A]/20 dark:shadow-[var(--conectia-arcilla)]/20">
                {t('common.contact')}
        ...
        <div className="grid md:grid-cols-12 gap-10 mb-16">
          ...
          {/* Contact */}
          <div className="md:col-span-4">
            <p className="text-[10px] uppercase tracking-[0.3em] text-[#17313A] dark:text-[var(--conectia-arcilla)] font-bold mb-5">{t('common.contact')}</p>
            <div className="space-y-4">
              <div className="flex items-start gap-3 group">
                <div className="w-8 h-8 rounded-lg bg-[#17313A]/10 dark:bg-[var(--conectia-arcilla)]/10 flex items-center justify-center flex-shrink-0 group-hover:bg-[#17313A]/20 dark:hover:bg-[var(--conectia-arcilla)]/20 transition-colors">
              ...
              <div className="flex items-start gap-3 group">
                <div className="w-8 h-8 rounded-lg bg-[#17313A]/10 dark:bg-[var(--conectia-arcilla)]/10 flex items-center justify-center flex-shrink-0 group-hover:bg-[#17313A]/20 dark:hover:bg-[var(--conectia-arcilla)]/20 transition-colors">
                  <Mail className="h-4 w-4 text-[#17313A] dark:text-[var(--conectia-arcilla)]" />
                </div>
                <div>
                  <p className="text-[11px] text-[#4A4F57] uppercase tracking-wider">Email</p>
                  <Link href="/contacto" className="text-sm text-[#17313A] dark:text-[#EAE4DD] hover:text-[#17313A] dark:hover:text-[var(--conectia-arcilla)] transition-colors">
                    conectia@gmail.com
                  </Link>
                </div>
              </div>
