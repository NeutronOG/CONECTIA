  ...
  return (
    <div className="min-h-screen bg-[#F6F2EE] dark:bg-[#17313A]">
      ...
      <div className="pt-24 pb-16 text-center">
        <h1 className="font-serif text-5xl md:text-6xl font-light text-[#17313A] dark:text-[#EAE4DD] mb-6">Sobre CONECTIA</h1>
      ...
      <div className="max-w-4xl mx-auto px-6 mb-24">
        <Card className="p-12 rounded-3xl glass-card rounded-3xl">
          <h2 className="font-serif text-3xl font-semibold text-[#17313A] dark:text-[#EAE4DD] mb-8 text-center">Nuestra Historia</h2>
      ...
      <div className="max-w-6xl mx-auto px-6 mb-24">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <Card className="p-8 text-center rounded-3xl glass-card rounded-3xl">
            ...
            <p className="text-[#4A4F57] dark:text-gray-400">
          ...
          <Card className="p-8 text-center rounded-3xl glass-card rounded-3xl">
            ...
            <p className="text-[#4A4F57] dark:text-gray-400">Comunicación clara y honesta en cada paso del proceso de venta.</p>
          </Card>
        </div>
      </div>
