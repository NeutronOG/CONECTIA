...
(4, 'Loft Condesa Premium', 'Condesa, CDMX', 12800000, '$12,800,000', 'Loft', 2, 2, 180, '180 m²', '/modern-loft-condesa.svg', 'Moderno loft en la vibrante Condesa, con techos altos y diseño industrial contemporáneo. Perfecto para profesionales que buscan estilo y ubicación privilegiada.', ARRAY['Techos altos', 'Diseño industrial', 'Ubicación central', 'Terraza privada', 'Vida nocturna', 'Parques cercanos'], 'Disponible', 'renta', '2024-03-01', NULL),

(6, 'Departamento Interlomas', 'Interlomas, Estado de México', 8500000, '$8,500,000', 'Departamento', 3, 3, 220, '220 m²', '/apartment-interlomas.svg', 'Cómodo departamento en Interlomas con amenidades completas y ubicación estratégica. Ideal para familias que buscan tranquilidad sin alejarse de la ciudad.', ARRAY['Amenidades completas', 'Ubicación estratégica', 'Seguridad', 'Áreas verdes', 'Club deportivo', 'Transporte'], 'Disponible', 'remate', '2024-01-25', NULL)
