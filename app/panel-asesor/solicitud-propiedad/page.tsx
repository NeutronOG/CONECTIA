        ...
        <div className="relative bg-white/[0.03] backdrop-blur-md border border-white/10 rounded-[28px] p-8 text-center max-w-md w-full z-10">
          ...
          <div className="relative">
            ...
            <div className="flex gap-3">
              ...
              <Button onClick={() => router.push('/panel-asesor/propiedades')} className="flex-1 bg-[var(--conectia-arcilla)] hover:bg-[var(--conectia-arcilla-hover)] text-[#0F2027] rounded-xl font-bold">{t('panelAsesor.request.backToProperties')}</Button>
            </div>
          </div>
        </div>
      </div>
