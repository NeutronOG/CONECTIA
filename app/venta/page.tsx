      ...
      <section className="relative min-h-[85dvh] flex flex-col lg:flex-row bg-[#F6F2EE] dark:bg-[#0F2027]">
        ...
        <div className="relative flex-1 lg:max-w-[50%] flex flex-col justify-center px-8 sm:px-12 lg:px-16 py-16 sm:py-20 z-10">
          <div className="max-w-xl space-y-8">
            ...
            <div>
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black text-[#17313A] dark:text-[#EAE4DD] leading-[0.95]">Venta</h1>
              <p className="text-2xl sm:text-3xl font-light text-[#C78F7B] dark:text-[#C78F7B] italic mt-2">al mejor precio</p>
            </div>

            <p className="text-[#4A4F57] dark:text-[#B0ACA6] text-base leading-relaxed max-w-md">
              Descubre propiedades en venta seleccionadas para ti. Casas, departamentos y terrenos listos para su nueva familia.
            </p>
        ...
        <div className="relative flex-1 min-h-[40vh] lg:min-h-0 p-4 lg:p-6 lg:pl-0">
          <div className="relative w-full h-full rounded-3xl overflow-hidden shadow-2xl">
            <img src={HERO_IMAGE} alt="Propiedades en venta" className="absolute inset-0 w-full h-full object-cover" />
            ...
            <div className="absolute bottom-6 right-6 bg-white/95 dark:bg-[#17313A]/95 backdrop-blur-sm rounded-2xl p-5 shadow-xl border border-[#17313A]/5 dark:border-[#EAE4DD]/10">
              ...
              <p className="text-xs text-[#B0ACA6] dark:text-[#B0ACA6]">+500 ventas exitosas</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-14 sm:py-20 px-4 sm:px-8 lg:px-16">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-end justify-between mb-6">
            <div>
              <span className="text-[10px] uppercase tracking-[0.35em] text-conectia-primary font-bold">En Venta</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            {propiedades.length === 0 && (<EmptyProperties label="Vuelve pronto para ver nuevas propiedades en venta" />)}
          </div>
        </div>
      </section>
    </div>
