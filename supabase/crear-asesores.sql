...
SELECT 
  ...
  'asesor' as role,
  CASE au.email
    WHEN 'roberto@arkin.mx' THEN '563-157-2468'
    WHEN 'maria@arkin.mx' THEN '563-157-2468'
    WHEN 'daniela@arkin.mx' THEN '563-157-2468'
    WHEN 'subje@arkin.mx' THEN '563-157-2468'
    WHEN 'gris@arkin.mx' THEN '563-157-2468'
    WHEN 'lizzie@arkin.mx' THEN '563-157-2468'
    WHEN 'ingrid@arkin.mx' THEN '563-157-2468'
    WHEN 'sofia.ayala@arkin.mx' THEN '563-157-2468'
  END as telefono
FROM auth.users au
WHERE au.email IN (
  'roberto@arkin.mx',
