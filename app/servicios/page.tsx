  ...
  return (
    <div className="min-h-screen bg-[#F6F2EE] dark:bg-[#17313A]">
      ...
      <div className="pt-20 sm:pt-24 pb-12 sm:pb-16 text-center px-4">
        <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-light text-[#17313A] dark:text-[#EAE4DD] mb-4 sm:mb-6">
          Nuestros Servicios
        </h1>
        <p className="text-lg sm:text-xl text-[#4A4F57] dark:text-[#B0ACA6] max-w-3xl mx-auto px-2 sm:px-6">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pb-16 sm:pb-24">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          <Card className="p-6 sm:p-8 rounded-2xl sm:rounded-3xl glass-card rounded-3xl">
            ...
            <p className="text-[#4A4F57] dark:text-gray-400 leading-relaxed mb-4 sm:mb-6 text-sm sm:text-base">
              Representación exclusiva de tu propiedad con atención personalizada y estrategia de marketing única.
            </p>
            <ul className="space-y-1 sm:space-y-2 text-xs sm:text-sm text-[#4A4F57] dark:text-[#B0ACA6]">
